...
func prineNum(intChan chan int, primeChan chan int, exitChan chan bool) {
...
func main() {
	...
	for i := 0; i < 16; i++ {
		wg.Add(1)
		go prineNum(intChan, primeChan, exitChan)
	}
